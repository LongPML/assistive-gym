...
class SMPLXTestingEnv(AssistiveEnv):
    def __init__(self):
        super(SMPLXTestingEnv, self).__init__(
            robot=None,
            human=None,
            task="smplx_testing",
            obs_robot_len=0,
    ...
    def reset(self):
        ...
        # joint_angles = []
        joint_angles = [
            (self.human_mesh.j_left_hip_x, -90),
            (self.human_mesh.j_right_hip_x, -90),
            (self.human_mesh.j_left_knee_x, 70),
            (self.human_mesh.j_right_knee_x, 70),
            (self.human_mesh.j_left_shoulder_z, -45),
            (self.human_mesh.j_left_elbow_y, -90),
        ]
        u = self.np_random.uniform
        joint_angles += [
            (self.human_mesh.j_right_pecs_y, u(-20, 20)),
            (self.human_mesh.j_right_pecs_z, u(-20, 20)),
            (self.human_mesh.j_right_shoulder_x, u(-45, 45)),
            (self.human_mesh.j_right_shoulder_y, u(-45, 45)),
            (self.human_mesh.j_right_shoulder_z, u(-45, 45)),
            (self.human_mesh.j_right_elbow_y, u(0, 90)),
            (self.human_mesh.j_waist_x, u(-30, 45)),
            (self.human_mesh.j_waist_y, u(-45, 45)),
            (self.human_mesh.j_waist_z, u(-30, 30)),
        ]
        self.human_mesh.init(
            self.directory,
            self.id,
            self.np_random,
            gender="female",
        ...
        self.human_mesh.set_base_pos_orient(
            chair_seat_position
            - self.human_mesh.get_vertex_positions(self.human_mesh.bottom_index),
            [0, 0, 0, 1],
        )
