...
class ScratchItchMeshEnv(ScratchItchEnv):
    ...
    def reset(self):
        ...
        joint_angles += [
            (self.human.j_right_shoulder_z, 45 + self.np_random.uniform(-10, 10)),
            (self.human.j_right_elbow_y, 90 + self.np_random.uniform(-10, 10)),
        ]
        ...
        joint_angles += [
            ...
            for j in (
                self.human.j_right_pecs_y,
                self.human.j_right_pecs_z,
                self.human.j_right_shoulder_x,
                self.human.j_right_shoulder_y,
        ...
        while True:
            ...
            target_ee_pos = np.array([-0.5, 0, 0.8]) + np.array(
                [
                    self.np_random.uniform(-0.2, 0.05),
